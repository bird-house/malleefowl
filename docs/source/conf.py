...
sys.path.insert(0, os.path.abspath("/home/Shared/pingu/sandbox/birdhouse/malleefowl/."))
...
latex_documents = [
  (master_doc, 'project.tex', u'Malleefowl Documentation',
   u'Birdhouse', 'manual'),
]
...
man_pages = [
    (master_doc, 'project', u'Malleefowl Documentation',
     [author], 1)
]
