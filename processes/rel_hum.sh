...
cdo -O merge $path'ps_'$filename $path'huss_'$filename $temp/merge_$filename
...
cdo expr,'es=6.1078*exp(17.08085*(tas-273.16)/(234.175+(tas-273.16)))' $path'tas_'$filename $temp/es_$filename

# calculate relative humidity 

cdo -div $temp/e_$filename  $temp/es_$filename $outpath'hurs_'$filename #setname
